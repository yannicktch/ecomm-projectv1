  ...
  categories: [
    {
      ...
      categories: [
        ...
        { name: 'Shorts', href: '#' },
        { name: 'Tees', href: '#' },
        { name: 'Pulls / Sweats', href: '#' },
        { name: 'Manteaux / Vestes', href: '#' },
      ],
      brands: [
    ...
    },
    {
      name: 'Marques',
      featured: [
        { name: 'Acne Studios', href: '#' },
        { name: 'Adidas', href: '#' },
        { name: 'Aimé Léon Dore', href: '#' },
        { name: 'AMI Paris', href: '#' },
        { name: 'Asics', href: '#' },
        { name: 'Autry', href: '#' },
        { name: 'Bape', href: '#' },
      ...
      categories: [
        { name: 'Billionaire Boys Club', href: '#' },
        { name: 'C.P. Company', href: '#' },
        { name: 'Gallery Dept.', href: '#' },
              ...
              <div className="border-b border-gray-200">
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="hidden lg:flex lg:items-center">
                    <a href="#">
                      <span className="sr-only">Yo mec </span>
                      <img
                        alt=""
                  ...
                  <a href="#" className="lg:hidden">
                    <span className="sr-only">Yfdfdfdf</span>
                    <img
                      alt=""
                      src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600"
                      className="h-8 w-auto"
